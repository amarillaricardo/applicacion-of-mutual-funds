...
class Modelo(Sujeto):
    def consultar_especifica(self,id_del_fondo,numero_de_años,tree2,root):
        if id_del_fondo == "":
            showinfo("Consulta especifica","Debe seleccionar un id de fondo para continuar, luego de haber consultado la ddbb. Gracias")
        elif id_del_fondo != "":
            if numero_de_años==0:
                showinfo("Consulta especifica","Debe seleccionar año para analisis de rentabilidad para continuar. Gracias")
                ...
                showinfo("Base de datos: Consulta","La consulta a la base de datos del fondo con id "+id_del_fondo +" se ha realizado con exito")
    ...
    def simulacion_cotizaciones_del_fondo(self,numero_de_años,root):
        ...
        return f"El resultado de la simulacion es la siguiente: {rentabilidad_anual_graph}"
